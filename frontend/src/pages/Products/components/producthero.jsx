      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-2 items-center text-center md:text-left">
          ...
          <div className="lg:col-span-5 flex flex-col items-center max-w-[480px] md:items-start z-10">
            {/* Label */}
            <div className="inline-flex items-center gap-2 text-[#4d8745] font-bold tracking-widest text-[11px] md:text-xs uppercase mb-3 md:mb-4">
              <Leaf size={14} className="text-[#61a355]" />
              <span>Our Products</span>
            </div>

            {/* Title */}
            <h1 className="font-serif text-[34px] sm:text-[42px] lg:text-[56px] text-[#1c3e1e] font-bold leading-[1.15] md:leading-[1.1] tracking-tight mb-4 text-center md:text-left">
              Nature-Inspired
              <br />
              Wellness Solutions
            </h1>
            ...
            {/* Paragraph */}
            <p className="text-[#556858] text-[14px] md:text-[17px] leading-relaxed max-w-[320px] md:max-w-[460px] mb-6 md:mb-8 mx-auto md:mx-0 text-center md:text-left">
          ...
          <div className="lg:col-span-7 relative h-[260px] sm:h-[350px] lg:h-[580px] -mx-4 sm:mx-0 lg:-mr-50 mt-8 lg:mt-0">
            <img
              src={hero}
        ...
        <div className="max-w-screen-2xl mx-auto px-3 md:px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 lg:gap-8 w-full px-0 mb-8">
            ...
            <div
              ...
              className="group w-full h-full bg-[#f4f5ed] border border-[#e5e7df] rounded-[16px] md:rounded-[24px] p-3 md:p-6 lg:p-8 flex flex-row md:flex-col justify-between overflow-hidden relative min-h-[100px] md:min-h-[260px] hover:shadow-[0_16px_36px_rgba(28,62,30,0.05)] transition-all duration-300 cursor-pointer "
            >
              {/* Left/Top Content */}
              <div className="w-[75%] md:w-full z-10 relative">
                <div className="flex flex-row md:flex-col items-start gap-3 md:gap-0 mb-1.5 md:mb-3">
                  {/* Icon Container */}
                  <div className="shrink-0 w-8 h-8 md:w-12 md:h-12 rounded-full bg-transparent border border-[#e2ead9] md:bg-white flex items-center justify-center text-[#4d8745] md:shadow-sm mb-0 md:mb-3">
                    <Leaf className="w-4 h-4 md:w-5 md:h-5" strokeWidth={1.5} />
                  </div>

                  <div className="flex flex-col">
                    {/* Title */}
                    <h4 className="font-bold text-[#1c3e1e] text-[15px] md:text-xl lg:text-[22px] leading-[1.2] mt-1 md:mt-0 mb-1 md:mb-1.5">
                      Signature Wellness
              ...
              <div className="absolute right-[-10px] md:right-0 bottom-[-20px] md:bottom-[-16px] w-[140px] md:w-[260px] h-[160px] md:h-[360px] pointer-events-none z-0">
                <img
                  src={signaturepr}
                  alt="no"
                  className="absolute bottom-2 md:bottom-8 right-0 md:right-[-56px] w-[125px] md:w-[260px] h-[135px] md:h-[280px] object-contain drop-shadow-md transition-transform duration-300"
                />
              </div>

              {/* Mobile Arrow Circle - Card 1 */}
              <div className="absolute bottom-2 right-2 md:hidden w-[22px] h-[22px] rounded-full bg-[#dce6d5] flex items-center justify-center text-[#1c3e1e] z-10 pointer-events-none">
                <ArrowRight className="w-3.5 h-3.5" />
              </div>
            </div>
            ...
            <div
              ...
              className="w-full h-full group bg-[#f4f5ed] border border-[#e5e7df] rounded-[16px] md:rounded-[24px] p-3 md:p-6 lg:p-8 flex flex-row md:flex-col justify-between overflow-hidden relative min-h-[100px] md:min-h-[260px] hover:shadow-[0_16px_36px_rgba(28,62,30,0.05)] transition-all duration-300 cursor-pointer"
            >
              <div className="w-[75%] md:w-full z-10 relative">
                <div className="flex flex-row md:flex-col items-start gap-3 md:gap-0 mb-1.5 md:mb-3">
                  <div className="shrink-0 w-8 h-8 md:w-12 md:h-12 rounded-full bg-transparent border border-[#e2ead9] md:bg-white flex items-center justify-center text-[#4d8745] md:shadow-sm mb-0 md:mb-3">
              ...
              <div className="absolute right-[-10px] md:right-[-10px] bottom-0 md:bottom-[-16px] w-[130px] md:w-[160px] h-[130px] md:h-[100px] pointer-events-none z-0">
                <img
                  src={ingredient}
                  alt="Signature products"
                  className="w-[115px] md:w-full h-[115px] md:h-auto object-contain absolute bottom-0 md:bottom-20 right-0 md:right-0 drop-shadow-md transform group-hover:scale-[1.03] transition-transform duration-300"
                />
              </div>
            ...
            >
              ...
              <div className="absolute right-[-10px] md:right-[-30px] bottom-[-20px] md:bottom-[-40px] w-[120px] md:w-[190px] h-[140px] md:h-[100px] pointer-events-none z-0">
                <img
                  src={leaf}
                  alt="Signature products"
                  className="w-[105px] md:w-full h-[105px] md:h-auto object-contain absolute bottom-0 md:bottom-20 right-0 md:right-0 drop-shadow-md transform group-hover:scale-[1.03] transition-transform duration-300"
                />
              </div>
        ...
        <div className="bg-[#f4f7f0] border border-[#e2ead9] rounded-[12px] md:rounded-[24px] py-4 px-2 md:p-8">
          <div className="flex flex-row md:grid md:grid-cols-4 justify-between items-center md:gap-8 w-full">
            ...
            <div className="flex flex-row items-center md:items-start gap-1.5 md:gap-4 w-auto text-left">

...
const HealthyLivingHero = () => {
    ...
    return (
        <>
            <section className="relative w-full min-h-[900px] sm:min-h-[800px] md:min-h-[600px] lg:min-h-[650px]  bg-white overflow-hidden pb-32 md:pb-32 pt-10 md:pt-0">
                ...
                <div className="relative flex items-start md:items-center">
                    <div className="absolute inset-0 md:inset-0 top-auto bottom-0 md:top-0 h-[50%] md:h-full z-0 flex justify-center md:justify-end">
                        <div className="relative w-full md:w-[70%] lg:w-[55%] h-full">
                            <img
                                src="wellness_family.png"
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-transparent w-[80%] md:w-[30%] hidden md:block"></div>
                    ...
                    <div className="absolute top-0 left-0 w-full md:w-[45%] lg:w-[30%] h-[55%] md:h-full bg-white z-0 md:block"></div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-24 relative z-20 mt-4 md:mt-0">
                        <div className="max-w-[800px] flex flex-col items-center md:items-start text-center md:text-left md:pt-10">
                            ...
                            <p className="text-gray-700 text-[13px] md:text-[15px] lg:text-[17px] mb-8 md:mb-10 leading-relaxed max-w-[500px] font-medium bg-white/50 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none p-2 md:p-0 rounded px-4 md:px-0">
                                Explore pratical wellness insights, nutrition guidance, family health tips, and nature-inspired habits designed to help you live healthier every day.
                            </p>

                            {/* Buttons */}
                            <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full md:w-auto px-4 md:px-0">
                                <a href="#insights" className="w-full md:w-auto justify-center bg-[#345920] hover:bg-[#2b4c18] text-white px-7 py-3 md:py-3.5 rounded text-[13px] md:text-[15px] font-bold transition-colors flex items-center gap-2 group shadow-sm border border-[#345920] w-fit">
                                    Explore Articles
                    ...
                    <div className="grid my-4 grid-cols-2 md:grid-cols-4 place-items-center rounded-xl gap-1 md:gap-4 w-full g p-[30px] md:py-[60px] bg-[#eeeeee] ">
                        {info.map((inf, i) => {
                            const dividerClasses = [
                                ...
                                'border-s',                                // 1: top-right    -> vertical (mobile + desktop)
                                'border-t md:border-t-0 md:border-s',      // 2: bottom-left  -> horizontal on mobile, vertical on desktop
                                'border-t border-s md:border-t-0',         // 3: bottom-right -> both on mobile, vertical only on desktop
                            ][i];
                            return (
                                <div className={` w-full flex border-green-100 justify-center p-2 ${dividerClasses}`}>
                                    <Infocard info={inf} />
                                </div>
                            )
                        })}
...
export default HealthyLivingHero
